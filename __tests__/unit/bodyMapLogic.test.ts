...
// La geometría de la silueta se mueve a `lib/humanFigureLogic.ts` y su propio
// archivo de test (`humanFigureLogic.test.ts`) — es lógica pura de verdad
// ahora, así que se importa en vez de leerse del componente con una regex.
