...
const s = StyleSheet.create({
  ...
  input: { backgroundColor: palette.graphite, borderColor: palette.line, borderWidth: 1, borderRadius: radii.md, padding: spacing.md, fontFamily: Fonts.sans, fontSize: 14, color: palette.ivory, minHeight: 44, justifyContent: 'center' },
  ...
  grantBtn: { backgroundColor: palette.gold, borderRadius: radii.md, minHeight: 44, alignItems: 'center', justifyContent: 'center', marginTop: spacing.lg },
