...
export const MORNING_HABITS: HabitTemplate[] = [
  {
    ...
    sequence:   1,
    points:     10,
    importance: 'Tras 7–8 horas sin líquidos, el cuerpo despierta deshidratado. El primer vaso de agua reactiva el metabolismo y ayuda a eliminar toxinas acumuladas durante la noche.',
    science:    'Reactiva el metabolismo. Elimina toxinas acumuladas.',
    reminderHour: 6,
    reminderMinute: 0,
  },
  {
